...
<template>
	<div class="w-full space-y-3">
		...
		<footer-banner-mobile
			...
			qr-code="/images/banner/mobile/KUD.webp"
			button-text="Installation Guide"
			button-link="/guide"
			android-apk-link="/download/app.apk"
			ios-app-link="https://apps.apple.com/myapp"
			background-image="/images/banner/mobile/bg-mobile-banner.webp"
			phone-image="/images/banner/mobile/download-apk-phone.webp"
		/>
	</div>
</template>
