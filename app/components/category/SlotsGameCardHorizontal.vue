...
const { gameByCategorySlug, baseImgUrl, filterGames } = useGames();
...
<template>
	<div class="w-full space-y-6">
				...
				<TransitionGroup name="game-card">
					...
					>
						...
						<div class="relative aspect-[4/3] overflow-hidden">
							...
							<button
								class="absolute top-2 right-2 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-black/50 backdrop-blur-sm transition-all hover:bg-black/70 active:scale-90"
							...
							>
								<button
									class="transform rounded-full bg-gradient-to-r from-yellow-400 to-yellow-600 px-8 py-2.5 text-sm font-bold text-gray-900 uppercase shadow-lg transition-all hover:from-yellow-500 hover:to-yellow-700 hover:shadow-yellow-500/50 active:scale-95 sm:px-10 sm:py-3 sm:text-base"
		...
		>
			...
			<button
				v-if="hasMore && !isLoadingMore"
				class="rounded-lg bg-gradient-to-r from-yellow-400 to-yellow-600 px-8 py-3 text-sm font-bold text-gray-900 uppercase transition-all hover:from-yellow-500 hover:to-yellow-700 hover:shadow-lg hover:shadow-yellow-500/50 active:scale-95"
				@click="loadMore"
			>
