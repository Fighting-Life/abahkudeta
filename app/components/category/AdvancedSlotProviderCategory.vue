...
<template>
	<div class="provider-section">
		...
		<Transition name="fade">
			<div
				v-if="!isDragging"
				class="flex items-center justify-center gap-2 py-2 text-xs text-neutral-400 lg:hidden"
			>
...
.carousel-btn {
	@apply z-10 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-neutral-800/50 text-white backdrop-blur-sm transition-all duration-200 hover:bg-neutral-700 lg:h-10 lg:w-10;
}
